...
import { BulkUpdatePayload, TestCase, TestCaseStatus, View } from '../types';
...
export const GeneratedTestCases: React.FC<GeneratedTestCasesProps> = ({ testCases, setActiveView, onBulkUpdate }) => {
